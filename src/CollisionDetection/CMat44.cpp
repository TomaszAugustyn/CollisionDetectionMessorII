#include "../include/CollisionDetection/CMat44.h"
#include <math.h>
...
void CMat44::loadFromTextFile(FILE * file){
    float tmp;
    fscanf(file, "mat=[");
    fscanf(file, "%lf ",&rotation[0]); fscanf(file, "%lf ",&rotation[1]); fscanf(file, "%lf ",&rotation[2]); fscanf(file, "%lf;",&pos[0]);
    fscanf(file, "%lf ",&rotation[3]); fscanf(file, "%lf ",&rotation[4]); fscanf(file, "%lf ",&rotation[5]); fscanf(file, "%lf;",&pos[1]);
    fscanf(file, "%lf ",&rotation[6]); fscanf(file, "%lf ",&rotation[7]); fscanf(file, "%lf ",&rotation[8]); fscanf(file, "%lf;",&pos[2]);
    fscanf(file, "%lf ",&tmp); fscanf(file, "%lf ",&tmp); fscanf(file, "%lf ",&tmp); fscanf(file, "%lf];\n",&tmp);
}
